...
namespace MyCookbook
{
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            executablePath = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"\MyCookbook";

            if (!System.IO.Directory.Exists(executablePath + @"\Cookbooks"))
                System.IO.Directory.CreateDirectory((executablePath + @"\Cookbooks"));
            executablePath += @"\Cookbooks";


            RJWynn.Debugging.MyDebug.Initialize(true, executablePath);
            ...
            try
            {
                ...
                if (config.AppSettings.Settings["Path"].Value == null || config.AppSettings.Settings["Path"].Value == "")
                {
                    config.AppSettings.Settings["Path"].Value = executablePath;
                }
            }
            catch
            {
                ...
                config.AppSettings.Settings.Add("Path", executablePath);
